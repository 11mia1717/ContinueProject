# Continue Bank 생태계 통합 프로젝트 (2026)
...
> **📢 주요 공지 (2026.01.30)**
> 1. **브랜드 변경**: 기존 `V-PASS` 본인인증 서비스명이 **`SSAP`**으로 변경되었습니다.
> 2. **프로젝트 구조**: 독립적인 관리를 위해 콜센터 시스템은 `call-center-project` 폴더로 분리되었습니다.
> 3. **포트 관리**: 전체 서비스의 포트가 최신 [시스템 포트 명세서](./system_port_specification.md)를 기준으로 재설정되었습니다.
